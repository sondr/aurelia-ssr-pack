import { RenderOptions, AppInitializationOptions, render } from './ssr-engine';
import { Context } from 'koa';

export const aureliaKoaMiddleware = (renderOptions: RenderOptions, initializationOptions: AppInitializationOptions) => {
